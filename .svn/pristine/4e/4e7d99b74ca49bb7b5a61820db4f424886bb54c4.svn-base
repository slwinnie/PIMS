...
<script runat="server">
    ...
    {
        SystemHelper.SetPageNo(this, "OpenProposal"); 
        ...
        if (!IsPostBack)
        {
            ...
            var item = db.TProposalX.Find(iProjectId, iSubId);
            if (item != null)
            {
            ...
            var risk = db.RiskClassificationForm.Find(iProjectId, iSubId, "1");
            if (risk != null)
            {
        ...
        $(function () {
            ...
            $("#open").click(function () {
                ...
                if (bootstrapValidator.isValid()) {
                    // 验证通过
                    $.ajax({
                        url: "Actions/OpenProposalAction.aspx?bkMode=1"
...
<!-- 导航菜单::结束 -->
    <!-- 导航地图::开始 -->
    <div><strong>PIMS</strong> > <a href="~/Project/Default.aspx" runat="server">Project Initiation</a> > <a href="../Project/ProposalInitiation.aspx?projectId=<%=Request["projectId"]%>">Proposal</a> > Open Proposal </div>
    <!-- 导航地图::结束 -->
    <div class="">
		<h3 class="text-center">Open Proposal</h3>
		</div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label>Proposal Status <span style="color:red;">*</span></label>
                <select runat="server" id="projectStatus" name="csg" class="form-control">
                    <option value="Proposal Executing">Proposal Executing</option>
                    <option value="Proposal Closed">Proposal Closed</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label>HSE Category <span style="color:red;">*</span></label>
...
<%--            <div class="form-group">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <%--<input type="text" id="csg" name="csg" runat="server" class="form-control" maxlength="2" placeholder="Valid length: 2"  />--%>
            ...
            <div class="form-group">
                ...
                <%--<input type="text" id="phase" name="phase" runat="server" class="form-control" maxlength="1" placeholder="Valid length: 1"/>--%>
            ...
            <div class="form-group">
                <label>Status</label>
<%--                <input type="text" id="status" name="status" runat="server" class="form-control" maxlength="1" placeholder="Valid length: 1"/>--%>
                <select id="status" name="status" runat="server" class="form-control" >
                    <option value="2">2-Proposal</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <input type="text" id="serialNo" name="serialNo" runat="server" class="form-control" maxlength="3" placeholder="Valid length: 3"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="text-info">New Proposal No:</label>
            ...
            <div class="text-center">
                <div class="btn-group">
                    <button type="submit" name="submit" class="btn btn-primary table" id="open">Open</button>
                </div>
            </div>
            <p>&nbsp;</p><p>&nbsp;</p>
            <label class="h4">Instruction:</label><br/>
            <div style="border: 1px solid lightgray; text-align: center; " class="py-1">
