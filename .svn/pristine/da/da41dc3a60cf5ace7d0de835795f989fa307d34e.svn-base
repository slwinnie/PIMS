...
<%
    ...
    sb.AppendFormat("\"{0}\":\"{1}\", ", "BidSubmitDate", StringHelper.FmtDate(item.BidSubmitDate));
    sb.AppendFormat("\"{0}\":\"{1}\", ", "BidApproveDate", StringHelper.FmtDate(item.BidApproveDate));
    sb.AppendFormat("\"{0}\":\"{1}\", ", "RiskSubmitDate", StringHelper.FmtDate(item.RiskSubmitDate));
    sb.AppendFormat("\"{0}\":\"{1}\", ", "RiskApproveDate", StringHelper.FmtDate(item.RiskApproveDate));
    sb.AppendFormat("\"{0}\":\"{1}\", ", "NPISSubmitDate", StringHelper.FmtDate(item.NPISSubmitDate));
    sb.AppendFormat("\"{0}\":\"{1}\"  ", "NPISApproveDate", StringHelper.FmtDate(item.NPISApproveDate));
    sb.AppendFormat("}}");
