...
<%
    ...
    else
    {
        ...
        item.Status = Request["txtProspectStatus"];
        ...
        //item.ProjectManagerId = string.IsNullOrEmpty(Request["projectManagerId"]) ? (int?)null : Convert.ToInt32(Request["projectManagerId"]);
