...
public partial class BNBAttach
{
    public int ProjectId { get; set; }
    public int SubId { get; set; }
...
public partial class NPISAttach
{
    public int ProjectId { get; set; }
    public int SubId { get; set; }
...
public partial class PAAF
{
    ...
    public Nullable<double> HourByPerson { get; set; }
    public Nullable<int> StartDate { get; set; }
    public Nullable<int> EndDate { get; set; }
    public Nullable<int> AuthorizedById { get; set; }
    public string PAAFStatus { get; set; }
    public Nullable<System.DateTime> ApprovedDate { get; set; }
}

public partial class PIFForm
{
    public int ProjectId { get; set; }
    public int SubId { get; set; }
    public string t1 { get; set; }
...
public partial class RiskClassificationForm
{
    public int ProjectId { get; set; }
    public int SubId { get; set; }
    public string type { get; set; }
...
public partial class SystemEmailReciver
{
    public int Id { get; set; }
...
public partial class SystemRiskManagementEmail
{
    public int Id { get; set; }
    public string RiskManagementEmail { get; set; }
}
...
public partial class TAccountRole
{
    public int AccountId { get; set; }
...
public partial class TCRMTLoader
{
    public int CRMDID { get; set; }
    public string FileName { get; set; }
...
public partial class TCRMTLoaderDetail
{
    public int CRMTID { get; set; }
    public string RowStatus { get; set; }
    public int ProjectId { get; set; }
    public string BusinessUnit { get; set; }
    public string BusinessLine { get; set; }
    public string OpportunityLeadSector { get; set; }
    ...
    public string WorleyParsonsCV { get; set; }
    public string WorleyParsonsEBIT { get; set; }
    public string EstimatedWork { get; set; }
    public string ContractDuration { get; set; }
    public string ContractType { get; set; }
    public string BidOffice { get; set; }
    public string FacilityLocationCountry { get; set; }
    public string WorkshareOffices { get; set; }
    public string Scopes { get; set; }
    public string OpportunityLeadSubsector { get; set; }
...
public partial class TFYear
{
    public int FYear { get; set; }
}

public partial class TFYearSerial
{
    public long FYear { get; set; }
    public Nullable<long> NextSerialNo { get; set; }
}
...
public partial class TOrganization
{
    ...
    public Nullable<int> LevelPos { get; set; }
}

public partial class TOrganizationPeoples
{
    public int OrganizationId { get; set; }
...
public partial class TPeople
{
    public int EmployeeId { get; set; }
    public Nullable<int> No { get; set; }
    public string PeopleNameChs { get; set; }
    public string PeopleNameEn { get; set; }
    public string Office { get; set; }
    public string Dispiline { get; set; }
    public string Title { get; set; }
    public string Phone { get; set; }
    public string Email { get; set; }
    public string CurrentWorkload { get; set; }
    public string ProjectNo { get; set; }
    public string PrposalNo { get; set; }
    public string StartDate { get; set; }
    public string EndDate { get; set; }
    public string ForecastWorkload { get; set; }
...
public partial class TProjectBasicInfo
{
    public string ProjectNo { get; set; }
    public string Type { get; set; }
...
public partial class TProjectContactList
{
    public string ProjectNo { get; set; }
    public string Type { get; set; }
    ...
    public string Email { get; set; }
    public string Company { get; set; }
    public Nullable<System.DateTime> PAAFDate { get; set; }
    public string Status { get; set; }
}

public partial class TProjectOwner
{
    public int ProjectId { get; set; }
    public int EmployeeId { get; set; }
}

public partial class TProjectRegister
{
    ...
    public string HSEResponsibility { get; set; }
    ...
    public string Workshare { get; set; }
    public string FinalCV { get; set; }
    public string FinalManhours { get; set; }
    public string CRMTID { get; set; }
    public Nullable<System.DateTime> RegisteredDate { get; set; }
    public string CustomerContactName { get; set; }
    public string TelNo { get; set; }
    public string ItemType { get; set; }
    public string TSEntity { get; set; }
    public string TSCategory { get; set; }
    public string TSClassification { get; set; }
    public string TSHSECategory { get; set; }
}

public partial class TProjectX
{
    public int ProjectId { get; set; }
    public int SubId { get; set; }
    public string ProjectNo { get; set; }
    ...
    public string ContractCurrency { get; set; }
    public Nullable<int> ProjectManagerId { get; set; }
    public Nullable<System.DateTime> BidSubmitDate { get; set; }
    public Nullable<System.DateTime> BidApproveDate { get; set; }
    public Nullable<System.DateTime> RiskSubmitDate { get; set; }
    public Nullable<System.DateTime> RiskApproveDate { get; set; }
    public Nullable<System.DateTime> NPISSubmitDate { get; set; }
    public Nullable<System.DateTime> NPISApproveDate { get; set; }
    public string CSG { get; set; }
    public string ProjectDescription { get; set; }
    public string ProjectType { get; set; }
    public string PType { get; set; }
    public string RiskClassificationFormStatus { get; set; }
    public string RiskWorkshareFormStatus { get; set; }
    public string NpisFormStatus { get; set; }
}

public partial class TProposalRegister
{
    public string CRMTID { get; set; }
    public string CSG { get; set; }
    public string Year { get; set; }
    ...
    public string SerialNo { get; set; }
    public string ProposalNo { get; set; }
    public string NamesOfImmediateClientOrOwner { get; set; }
...
public partial class TProposalX
{
    public int ProjectId { get; set; }
    public int SubId { get; set; }
    public string ProposalNo { get; set; }
    ...
    public string ProposalDescription { get; set; }
    public string PType { get; set; }
    public string BidFormStatus { get; set; }
    public string RiskClassificationFormStatus { get; set; }
    public string NpisFormStatus { get; set; }
}

public partial class TRiskWorkshare
{
    public int ProjectId { get; set; }
    public int SubId { get; set; }
    public string type { get; set; }
...
public partial class TRoleDetail
{
    public int RoleId { get; set; }
    public int No { get; set; }
...
public partial class TSProjectTotalHMs
{
    public string ProjectNo { get; set; }
    public string EmployeeId { get; set; }
    ...
    public string ProjectType { get; set; }
    public Nullable<double> TotalMHs { get; set; }
    public Nullable<double> Sat { get; set; }
    public Nullable<double> Sun { get; set; }
    public Nullable<double> Mon { get; set; }
    public Nullable<double> Tue { get; set; }
    public Nullable<double> Wed { get; set; }
    public Nullable<double> Thr { get; set; }
    public Nullable<double> Fri { get; set; }
}

public partial class TStaffingBasicInfo
{
    public Nullable<int> No { get; set; }
    public int EmployeeId { get; set; }
    public string Position { get; set; }
...
public partial class TStaffingPlan
{
    public string WBS { get; set; }
    public string CTR { get; set; }
    public Nullable<decimal> BudgetHours { get; set; }
    public Nullable<decimal> PlannedHours { get; set; }
...
public partial class TStaffingPlanDetail
{
    public Nullable<int> No { get; set; }
    public string ProjectNo { get; set; }
    public string Type { get; set; }
    ...
    public string Position { get; set; }
    public int EmployeeId { get; set; }
    public Nullable<decimal> HourByPerson { get; set; }
}

public partial class TStaffingPlanDetailYearMonth
{
    public string ProjectNo { get; set; }
    public string Type { get; set; }
    public string WBS { get; set; }
    ...
    public Nullable<decimal> YearMonthValue { get; set; }
}
